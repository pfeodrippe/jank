...
- [x] imgui
  ...
  - [x] wasm
- [ ] perf
  - [x] strategy 0 - hash forms so we don't reload them again
  - [ ] can we improve strategy 0 so we don't need even to parseExecute it (without causing stale issues)?
  - [ ] local cache file so it can survive restarts
- [ ] flecs
