...
namespace jank::runtime
{
   ...
   * The definition in arena.cpp has visibility("default") + used for Linux emulated TLS -
   * the __emutls_v.* symbol must be visible and not stripped for the ORC JIT to resolve it. */
