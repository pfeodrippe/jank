...
{
  static native_unordered_map<char, jtl::immutable_string_view> const munge_chars{
    {  '-',        "_" },
    {  ':',  "_COLON_" },
    {  '+',   "_PLUS_" },
    {  '>',     "_GT_" },
  ...
  static native_vector<std::pair<jtl::immutable_string_view, char>> const demunge_chars{
    { "_LBRACE_",  '{' },
    { "_RBRACE_",  '}' },
    { "_LBRACK_",  '[' },
    { "_RBRACK_",  ']' },
  ...
  static native_set<jtl::immutable_string_view> const cpp_keywords{ "alignas",
                                                                    "alignof",
                                                                    "and",
                                                                    "and_eq",
                                                                    "asm",
  ...
  static native_set<jtl::immutable_string_view> const munged_cpp_keywords{
    "alignas__",
    "alignof__",
    "and__",
    "and_eq__",
  ...
  jtl::immutable_string demunge(jtl::immutable_string const &o)
  {
    ...
    {
      usize pos{};
      auto const pattern_length{ pair.first.size() };
